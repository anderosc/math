...
const MultiplicationScores: React.FC = () => {
  const userId = auth.currentUser?.uid || ""; 
  const { scores, loading } = useScores("multiplication_scores", userId);
 ...
 {loading ? (
        ...
        <div>
          <h3> Multiplication Average Score: {averageScore}</h3>
...
export default MultiplicationScores;